...
**Período**: 2022 Semestre 2  
**Tipo**: Prueba 2

## Descripción

Solución para Prueba 2 de Programación Avanzada.
...
Este código se encuentra en: `Prog. Avanzada/PRUEBA 2/2022 S2/Solución/src/`
...
1. **Crear un nuevo proyecto Java en Eclipse:**
   - `File` → `New` → `Java Project` → Nombre: `Prueba2_ProgAvanzada` → Finish

2. **Copiar los archivos `.java`:**
   - Abre el Explorador de archivos
   - Ve a `Prog. Avanzada/PRUEBA 2/2022 S2/Solución/src/`
